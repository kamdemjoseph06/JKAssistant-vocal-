...
void main() {
  ...
  late IntentRecognizer nlu;

  setUp(() {
    parser = CommandParser();
    nlu = IntentRecognizer();
  });
  ...
  group('📞 Appels — FR', () {
    final callPhrases = [
      ...
      'contacte Marie',
      'joins Pierre',
      'compose le numéro de Sophie',
      'passe-moi Jean',
      // Phrases naturelles
      'je voudrais appeler Jean',
      'peux-tu appeler maman',
      'je veux joindre papa',
      'essaie de contacter Marie',
      'lance un appel à Pierre',
      // Fautes de prononciation légères
      'apelle Jean',       // une seule l
      'appelé maman',      // mauvais accord
      'telephoner papa',   // sans accent
    ];
  ...
  group('📞 Appels — EN', () {
    final callPhrases = [
      ...
      'please call dad',
      'try to reach Marie',
      'connect me to Pierre',
      'put me through to Sophie',
  ...
  group('✅ Décrocher — FR', () {
    final answerPhrases = [
      ...
      'ouvre la ligne',
      // Fautes légères
      'decroche',        // sans accent
      'repondre',        // sans accent
    ];
  ...
  // ══════════════════════════════════════════════════════════
  // TESTS LEVENSHTEIN — Tolérance aux fautes
  // ══════════════════════════════════════════════════════════
  ...
  // ══════════════════════════════════════════════════════════
  // TESTS NÉGATIFS — Ne pas reconnaître des phrases vides/hors sujet
  // ══════════════════════════════════════════════════════════
  ...
  // ══════════════════════════════════════════════════════════
  // TESTS LEVENSHTEIN DIRECT
  // ══════════════════════════════════════════════════════════
  group('📏 Distance Levenshtein', () {
    test('Mots identiques → distance 0', () {
      final nluPrivate = IntentRecognizer();
      // Test via reconnaissance indirecte
      final cmd = parser.parse('appelle Jean');
